...
export default function EmployeesTableSkeleton() {
  return (
    <div className="bg-white shadow-sm rounded-xl border border-gray-200 p-5 mt-0 w-full">
      {/* موبايل */}
        ...
        <table className="min-w-full border-separate border-spacing-y-3">
          <thead>
            <tr className="bg-pink-50">
              ...
              <th className="p-3 text-[13px] text-gray-600">الاسم</th>
              <th className="p-3 text-[13px] text-gray-600">الكنية</th>
              <th className="p-3 text-[13px] text-gray-600">الوظيفة</th>
              <th className="p-3 text-[13px] text-gray-600">الهاتف</th>
